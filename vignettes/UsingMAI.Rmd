...
```{r}
# Get BPCA imputation imputed data
## meta_assay_ the value assigned to assay_ix
metadata(Results)[["meta_assay_1"]][["MCAR_imputations"]][1:5, 1:5] # show only 5x5

# Get Single imputation imputed data
metadata(Results)[["meta_assay_1"]][["MNAR_imputations"]][1:5, 1:5] # show only 5x5
```
